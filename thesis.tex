...
\newcommand{\clientReq}[1]{$r_{c\mapsto n_{#1}}$\xspace}
\newcommand{\nodeReqResponse}[1]{$rp_{n_{#1}\mapsto c}$\xspace}
...
\newcommand{\mutations}{$\Delta(t)$\xspace}
\newcommand{\mutationsi}[1]{$\Delta(t_{#1})$\xspace}
\newcommand{\txItem}{$ti$\xspace}
