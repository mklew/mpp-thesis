...
Cluster tests were performed independently on two clusters with \RF{3} and \N{5}. Tests run on $5$ nodes yielded important results, because with $5$ nodes and \RF{3} there are at most $10$ replica groups. 
