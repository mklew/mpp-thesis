...
\item $\mathit{find(\text{\txState})} \mapsto \mathit{log\_state}$ -- finds information about a transaction. Returns $\mathit{log\_state}$ which can be one of: \begin{enumerate*} 
