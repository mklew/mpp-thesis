...
\subsubsection{Algorithm for adding operations to private transaction storage}
...
\subsection{Addressing paxos requirements}
...
\subsubsection{Ability to find paxos state at node given transaction state (value).}
...
\subsubsection{Conflicting transactions}
...
\subsubsection{Replica groups in details}
...
\subsection{Pre prepare phase description}
...
\subsection{Rollback phase in details}
...
\subsection{Prepare phase in details}
...
\subsection{Propose phase in details}
...
\subsection{Commit phase in details}
...
\subsection{Repairing phase in details}
