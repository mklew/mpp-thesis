...
%If there are many transactions being committed at the same time, and those transactions are in conflict with each
...
%If there are many values being proposed at the same time, only one value should be accepted and nodes should consensus
