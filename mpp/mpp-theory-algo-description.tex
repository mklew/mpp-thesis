...
$N^'_2=(n_3,n_4,n_5)$. Furthermore let us assume that \mutation{k_1}{v_1} is present in each \txStorage of each $n\in N^'_1$ and \mutation{k_2}{v_2} is present in each \txStorage of each $n\in N^'_2$, thus \transaction is ready for the commit procedure, which we analyze step by step:

Tableka która pokazuje stan tego co jest:



% Step & State of  & Phase of replica & Next transition & 

% \begin{figure}
% \centering
% \begin{tabular}{c|c|c|c}
% 	\toprule
%     Node & Phase & State of \txStorage  \\ \midrule
%     $n_1$
%     \\ \bottomrule
%   \end{tabular}     
%  \caption{Payload of $\mathit{prepare\_response}$}
