...
\newcommand{\setupTransition}{$\mathit{setup\_transition()}$}
\newcommand{\prepareTransition}{$\mathit{prepare\_transition()}$}
\newcommand{\proposeTransition}{$\mathit{propose\_transition()}$}
\newcommand{\commitTransition}{$\mathit{commit\_transition()}$}
