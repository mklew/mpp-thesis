...
Actors in \paxos have one of more of the following roles: \begin{enumerate*}[label=\alph*)]
...
\begin{figure}[H]
  \centering
  TODO na diagramie jest bałagan, ale to pozniej poprawie, załóż, że widać tutaj dwóch proposerów

  \begin{sequencediagram} 
  	\newthread[blue]{c}{:Proposer 1} 
  	\newinst{n1}{:Acceptor 1}
  	\newinst{n2}{:Acceptor 2}
  	\newinst{n3}{:Acceptor 3}
  	\newthread{c2}{:Proposer 2}

	\mess[1]{c}{prepare $ballot_1$}{n1}
	% \prelevel
	\mess[1]{c}{prepare $ballot_1$}{n2}
	\prelevel
	\mess[1]{n1}{promise}{c}
	% \prelevel
	% \prelevel	
	...
	\prelevel
	\prelevel
	\mess[1]{c}{prepare $ballot_1$}{n3}
	\mess[1]{n3}{promise}{c}
	
	\mess[1]{c}{propose $ballot_1, value_1$}{n1}
	\prelevel
	\mess[10]{c}{propose $ballot_1, value_1$}{n2}
	\prelevel
	\prelevel
	\prelevel
	\prelevel
	...
	\prelevel
	\mess[1]{n1}{accept}{c}
	\mess[1]{c2}{prepare $ballot_2$}{n1}	
	\mess[1]{n1}{promise $ballot_1, value_1$}{c2}
	\prelevel
	
	\mess[1]{c2}{prepare $ballot_2$}{n2}	
	\mess[1]{n2}{promise}{c2}

	\mess[1]{n2}{decline}{c}
	\prelevel
	\mess[1]{c2}{prepare $ballot_2$}{n3}
	...
	\prelevel
	\prelevel
	\mess[5]{c}{propose $ballot_1, value_1$}{n3}
	\mess[1]{n3}{decline}{c}
	...
	\mess[1]{c2}{propose $ballot_2, value_1$}{n1}
	\prelevel
	\mess[2]{c2}{propose $ballot_2, value_1$}{n2}
	\prelevel
	\prelevel
	\mess[2]{c2}{propose $ballot_2, value_1$}{n3}

	\mess[1]{n1}{accept}{c2}
	\mess[1]{n2}{accept}{c2}
	\mess[1]{n3}{accept}{c2}

	\mess[1]{c2}{commit $ballot_2$}{n1}
	\prelevel
	\mess[2]{c2}{commit $ballot_2$}{n2}
	\prelevel
	\prelevel
	\mess[2]{c2}{commit $ballot_2$}{n3}
...
\end{sequencediagram}
  ...
  \caption{Paxos round with two proposers}
